...
welcome to rabbitmq/init<br>
exchange:<input id="exchange"></input><br>
routingKey:<input id="routingKey"></input><br>
message:<input id="message"></input><br>
<button id="sendToBroker">sendToBroker</button><br>
<div id="output"></div>

<script type="text/javascript" src="${jsPrefix }/static/jms_v2/js/rabbitmq/init.js" ></script>
</body>
<!-- END BODY -->
</html>